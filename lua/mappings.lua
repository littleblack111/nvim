...
map("n", "<leader>1", function() safe_goto_buf(1) end, { desc = "Go to buffer 1" })
map("n", "<leader>2", function() safe_goto_buf(2) end, { desc = "Go to buffer 2" })
map("n", "<leader>3", function() safe_goto_buf(3) end, { desc = "Go to buffer 3" })
map("n", "<leader>4", function() safe_goto_buf(4) end, { desc = "Go to buffer 4" })
map("n", "<leader>5", function() safe_goto_buf(5) end, { desc = "Go to buffer 5" })
map("n", "<leader>6", function() safe_goto_buf(6) end, { desc = "Go to buffer 6" })
map("n", "<leader>7", function() safe_goto_buf(7) end, { desc = "Go to buffer 7" })
map("n", "<leader>8", function() safe_goto_buf(8) end, { desc = "Go to buffer 8" })
